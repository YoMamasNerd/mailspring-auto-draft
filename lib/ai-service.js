...
// der Diagnose, wenn kein Text extrahiert werden konnte.
...
async function generateReply({
  ...
  let result = await requestOnce(body, onToken);

  // Manche Backends liefern zwar einen SSE-Stream, aber in einem Format ohne
  // extrahierbaren Text. Dann einmal automatisch ohne Streaming nachfragen.
