...
module.exports = {
  ...
  async checkForUpdates(force = false) {
    ...
    const now = Date.now();
    const interval = getConfig('autoUpdateCheckInterval') || 24 * 60 * 60 * 1000;
    ...
    const currentVersion = PLUGIN_VERSION || '0.3.0';
  ...
  // Hilfsfunktion: Versionsvergleich (SemVer)
  // Return: 1 wenn a > b, -1 wenn a < b, 0 wenn gleich
  compareVersions(a, b) {
