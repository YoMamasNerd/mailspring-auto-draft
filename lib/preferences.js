...
const FIELDS = [
  ...
  },
  {
    ...
    type: 'checkbox',
    help:
      'Prüft alle 5 Minuten die Verbindung zum Backend. Bei Fehlschlag zeigt das Panel einen Hinweis.',
  },
  {
    key: 'failoverEnabled',
    ...
    type: 'checkbox',
    help:
      'Wenn Health-Check fehlschlägt, wird automatisch das nächste Modell aus der Fallback-Liste probiert.',
  },
  {
    key: 'failoverModels',
    ...
    help:
      'Reihenfolge der Modelle für Auto-Failover. Werden nacheinander probiert, wenn das Hauptmodell nicht antwortet.',
  },
];
